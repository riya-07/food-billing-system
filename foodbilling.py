...
Tops = Frame(root,bg='yellow',bd=20,pady=5,relief=RIDGE)
Tops.pack(side=TOP)
...
ReceiptCal_F = Frame(root,bg='yellow',bd=10,relief=RIDGE)
...
Receipt_F=Frame(ReceiptCal_F,bg='yellow',bd=4,relief=RIDGE)
